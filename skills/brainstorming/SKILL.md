...
6. **Write design doc** — save to `docs/superpowers/specs/YYYY-MM-DD-<topic>-design.md`, commit and push
...
- When presenting multiple choice options, always clearly mark the recommended option (e.g., `**[recommended]**` or `**[推奨]**`)
